// sweetalert2@11.16.0 downloaded from https://ga.jspm.io/npm:sweetalert2@11.16.0/dist/sweetalert2.all.js
...
/**
   ...
   *
   * @param {SweetAlertOptions} params
   */const showWarningsForParams=e=>{e.backdrop===false&&e.allowOutsideClick&&warn('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');e.theme&&!["light","dark","auto"].includes(e.theme)&&warn(`Invalid theme "${e.theme}". Expected "light", "dark", or "auto"`);for(const t in e){checkIfParamIsValid(t);e.toast&&checkIfToastParamIsValid(t);checkIfParamIsDeprecated(t)}};
/**
